...
Let's use Org-mode links to look-up Quranic and Biblic verses!
...
/Super short example.../
   ...
   #+begin_org-demo :source-color green :result-color white :style sequential
...
* Longer Example
  ...
  :END:
   ...
   #+begin_org-demo :style sequential :source-color green :result-color white
 Sometimes I want to remember the words of the God of Abraham. In English Bibles,
 His name is “Elohim”, whereas in Arabic Bibles and the Quran, His name is
 “Allah”. We can use links to quickly access them, such as quran:7:157|darkgreen
 and bible:Deuteronomy:18:18-22|darkblue.  Arab-speaking Christians and Muslims
...
following.
#+BEGIN_SRC emacs-lisp :tangle no
(holy-books--defblock src (lang nil) (title nil exports nil file nil)
...
13. Create a recipe file by invoking: M-x package-build-create-recipe
    ...
    *Or:* Uncomment this section & just tangle the following.
    ...
    (holy-books :fetcher github :repo "alhassy/holy-books")
        #+END_SRC
14. Produce a dedicated pull request branch
...
15. Ensure the recipe builds successfully:
    #+BEGIN_SRC shell :tangle no
    cd ~/melpa; rm ~/melpa/packages/holy-books-*; make recipes/holy-books
    #+END_SRC

    #+RESULTS:
    : • Building package holy-books ...
16. Ensure the package installs properly from within Emacs:

      #+BEGIN_SRC emacs-lisp :tangle no
(package-install-file "~/melpa/packages/holy-books-20200417.238.el")
#+END_SRC
      #+RESULTS:
...
,#+INCLUDE: ~/holy-books/holy-books.org::#Installation-Instructions :only-contents t
,* Minimal working example
,#+INCLUDE: ~/holy-books/holy-books.org::#Minimal-working-example :only-contents t
,* Bye!
,#+INCLUDE: ~/holy-books/holy-books.org::#Bye :only-contents t
")
